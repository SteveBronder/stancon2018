...
```{r echo = FALSE, fig.cap="\\label{fig:GP_results}Visualizations of speedup when using our GPU approach compared to the default CPU implementation. For simulations ran with the default CPU implementation we only ran simulations up to $N = 2048$, times reported for larger N are estimated from measurements for smaller N.", fig.width = 12, fig.height = 6}
